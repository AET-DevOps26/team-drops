...
const translations = {
  English: {
    ...
    authDescription: 'Build stronger answers with guided speaking practice and feedback made for software interviews.',
  ...
  German: {
    ...
    authEyebrow: 'Dein persönlicher Interview-Coach',
    authTitle: 'Gezielt üben. Selbstbewusst ins Interview.',
    authDescription: 'Verbessere deine Antworten mit geführten Sprechübungen und Feedback für Software-Interviews.',
    authPracticeLabel: 'Übungsfrage',
    authPracticeQuestion: 'Erzähle von einem Projekt, auf das du stolz bist.',
    authFeedbackReady: 'Feedback bereit',
    authBenefitsLabel: 'Vorteile von InterviewMate',
  ...
  French: {
    ...
    authEyebrow: 'Votre coach personnel d’entretien',
    authTitle: 'Entraînez-vous avec méthode. Réussissez avec confiance.',
    authDescription: 'Améliorez vos réponses avec des exercices oraux guidés et des retours adaptés aux entretiens logiciels.',
    authPracticeLabel: 'Question d’entraînement',
    authPracticeQuestion: 'Parlez-moi d’un projet dont vous êtes fier.',
    authFeedbackReady: 'Retour disponible',
    authBenefitsLabel: 'Avantages d’InterviewMate',
