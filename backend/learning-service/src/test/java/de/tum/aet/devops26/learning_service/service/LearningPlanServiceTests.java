...
class LearningPlanServiceTests {
    ...
    void createDefaultLearningPlanCopiesCatalogLessonsAndExercises() {
        ...
        assertThat(savedPlan.getDescription()).isEqualTo("Fixed lessons for practicing professional job interview answers.");
        ...
        assertThat(exerciseCaptor.getAllValues())
            ...
            .allSatisfy(exercise -> {
                ...
                assertThat(exercise.getExpectedAnswer())
                    .isEqualTo("Write a clear, professional answer using specific details and formal vocabulary.");
            });
        assertThat(exerciseCaptor.getAllValues())
